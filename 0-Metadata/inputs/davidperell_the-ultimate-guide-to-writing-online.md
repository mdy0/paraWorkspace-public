## Metadata
* Original Source: https://perell.com/essay/the-ultimate-guide-to-writing-online/
...
| Ambient Research | Active Research |
| :--- | :--- |
| Divergent | Convergent |
| Passive | Active |
| Already happening | Need to make time |
| Free | Expensive |
| Playful | Focused |
| The world | Your desk |
...
*(Drawing omitted: Two panels, one labeled READING filled with scattered dots, one labeled WRITING featuring a dog statue.)*
...
*(Drawing omitted: Two panels, one labeled FIRST DRAFT featuring a blue square on a marble block, one labeled FINAL DRAFT featuring a marble statue.)*
...
The gift of the Internet is that it lets us test ideas at scale. In this section, I'm going to show you how to do that. I'll start by showing you how ideas develop: first, with friends; then with readers; and finally, with editors.

Each phase helps you refine your ideas. What begins as messy notes get **distilled** into memorable phrases that'll ring in your readers' mind long after they've finished your piece.
...
*(Image omitted: Screenshots of two newsletter replies highlighting phrases like "Hugging the X-axis.")*
...
*(Image omitted: Diagram of The Content Triangle with three stages: Conversations with Friends, Conversations with Readers, Conversations with Editors.)*
...
*(Image omitted: Chart showing Twitter follower growth comparison between Kyiv Post and The Kyiv Independent, where The Kyiv Independent's growth curve is significantly steeper.)*
...
*(Image omitted: Screenshot of Ana Lorena Fabrega's Start Here page, titled "FROM TEACHER TO EDUPRENEUR.")*
...
*(Image omitted: Screenshot of Julian Shapiro's website with categories for Start a Startup, Write Well, Build Muscle, and Podcast.)*
...
*(Image omitted: Screenshot of the Wait But Why website, showing a mailbag drawing and stick figure graphics.)*
...
*(Image omitted: Screenshot of Charlie Bleecker's website featuring a high-contrast photo and the introduction: "Hey, I'm Charlie".)*
...
*(Image omitted: Diagram illustrating the structure of a friendly 'Digital Postcard' with elements like Quick hello, Update about your life, Link to your writing, How people can help you, and Personal ending. A text example from Justin Mares is shown next to it.)*
...
*(Image omitted: Quote box featuring a paragraph from Rory Sutherland’s Alchemy, labeled Personal | Observational | Playful.)*
...
*(Image omitted: Poster for the movie Snakes on a Plane.)*
...
*(Image omitted: A highly realistic painting by Monet, Garden at Sainte-Adresse.)*
...
*(Image omitted: A blurry, abstract painting of water lilies by Monet, from the Musée de l'Orangerie.)*
...
*(Image omitted: Screenshot of Ernest Hemingway's writing run through Grammarly, showing numerous recommendations to change words or add commas.)*
...
*(Call-to-action block omitted: Download Your Personal Monopoly Guide)*
